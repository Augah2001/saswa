...
import type { Project, Resource, GalleryImage } from '@prisma/client';
...
export default function HomePageClient({
  ...
  latestGalleryImages: GalleryImage[];
}) {
  const { ref: joinAllianceRef, isInView: joinAllianceInView } = useInViewAnimation<HTMLDivElement>();
  const { ref: projectsRef, isInView: projectsInView } = useInViewAnimation<HTMLDivElement>();
  const { ref: resourcesRef, isInView: resourcesInView } = useInViewAnimation<HTMLDivElement>();
  const { ref: galleryRef, isInView: galleryInView } = useInViewAnimation<HTMLDivElement>();
